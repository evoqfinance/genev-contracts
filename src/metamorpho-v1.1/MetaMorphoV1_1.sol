...
import {MarketConfig, PendingUint192, PendingAddress, MarketAllocation, IMetaMorphoV1_1Base, IMetaMorphoV1_1StaticTyping} from "./interfaces/IMetaMorphoV1_1.sol";
...
contract MetaMorphoV1_1 is ERC4626, ERC20Permit, Ownable2Step, Multicall, IMetaMorphoV1_1StaticTyping {
        ...
        returns (uint256 feeShares, uint256 newTotalAssets, uint256 newLostAssets)
    {
        ...
        if (realTotalAssets < lastTotalAssets - lostAssets)
            newLostAssets = lastTotalAssets - realTotalAssets;
